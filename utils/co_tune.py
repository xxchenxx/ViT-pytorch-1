...
def transform_train(normalize, resize_size=256, crop_size=224):
...
def get_transforms(normalize, resize_size=256, crop_size=224):
    transforms = {
        'train': transform_train(normalize, resize_size, crop_size),
