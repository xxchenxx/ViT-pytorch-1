...
do
CUDA_VISIBLE_DEVICES=${devices} python3 -m torch.distributed.launch --nproc_per_node=${n_gpu} --master_port ${port}  \
train.py --name cub200-lr${lr}-B128E100-Mesa --learning_rate ${lr} --num_workers 2 --output_dir ${save_dir} \
--dataset cub200 --model_type ViT-B_16 --pretrained_dir ${save_dir}/pretrain/ViT-B_16.npz \
--mesa \
...
do
CUDA_VISIBLE_DEVICES=${devices} python3 -m torch.distributed.launch --nproc_per_node=${n_gpu} --master_port ${port}  \
train.py --name cub200-lr${lr}-B128E100-fix_mlps --learning_rate ${lr} --num_workers 2 --output_dir ${save_dir} \
--dataset cub200 --model_type ViT-B_16 --pretrained_dir ${save_dir}/pretrain/ViT-B_16.npz \
--fix_mlps \
--train_batch_size 128 --eval_batch_size 128 \
--num_steps 6000 --eval_every 1000
...
do
CUDA_VISIBLE_DEVICES=${devices} python3 -m torch.distributed.launch --nproc_per_node=${n_gpu} --master_port ${port}  \
train.py --name cub200-lr${lr}-B128E100-bitfit --learning_rate ${lr} --num_workers 2 --output_dir ${save_dir} \
--dataset cub200 --model_type ViT-B_16 --pretrained_dir ${save_dir}/pretrain/ViT-B_16.npz \
--bitfit \
--train_batch_size 128 --eval_batch_size 128 \
--num_steps 6000 --eval_every 1000
