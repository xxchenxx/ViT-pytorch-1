...
def init_datasets(args, transform_train, transform_test):
    ...
    if args.dataset == "cifar10":
        ...
        val_datasets = datasets.CIFAR10(root="./data", train=False, download=True, transform=transform_test)
        ...
        val_datasets = datasets.CIFAR100(root="./data", train=False, download=True, transform=transform_test)
        ...
        root, txt_train, txt_val, txt_test = get_dtd_data_split(args.data, args.customSplit)
        ...
        root, txt_train, txt_val, txt_test = get_iNaturalist_data_split(args.data, args.customSplit)
    ...
    elif args.dataset == 'places_sub100':
        root, txt_train, txt_val, txt_test = get_places_sub100_data_split(args.data, args.customSplit)
        ...
        train_datasets = Custom_Dataset(root=root, txt=txt_train, transform=transform_train, pre_load=False)
        val_datasets = Custom_Dataset(root=root, txt=txt_val, transform=transform_test)
        test_datasets = Custom_Dataset(root=root, txt=txt_test, transform=transform_test)
        ...
        root, txt_train, txt_val, txt_test = get_Caltech101_data_split(args.data, args.customSplit)
        train_datasets = Custom_Dataset(root, txt_train, transform=transform_train)
        val_datasets = Custom_Dataset(root, txt_val, transform=transform_test)
        test_datasets = Custom_Dataset(root, txt_test, transform=transform_test)
...
def get_imagenet_root_path(root):
    ...
    if os.path.isdir(root):
        pass
    # elif os.path.isdir("/home/t-xiaochen/imagenet"):
    #     root = "/home/t-xiaochen/imagenet"
